<div id="payment-info">
    <form method="POST" action="{{ route('holiday-park.booking.begin-payment') }}" id="payment-form">
        ...
        <div class="form-fields form-section">
            ...
            <div class="hidden form-field-inline">
            ...
            <div class="hidden form-field-inline">
                <input type="hidden" name="booking_no" id="booking_no" value="{{ $booking->booking_no }}">
            </div>
        </div>
        ...
        <div class="form-fields form-section">
            <div class="form-field-inline">
                ...
                <input type="text" name="customerFirstName" id="customerFirstName" autocomplete="given-name">
            </div>
    ...
    <div class="pay-now">
        <button id="pay-now-button" class="btn secondary-btn pay-btn" type="submit" form="payment-form"
            value="Submit">
